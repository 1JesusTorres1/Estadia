                ...
                <div class="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <a href="#" 
                       class="group bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 flex items-center space-x-4 hover:shadow-xl hover:scale-105 transition-transform duration-200">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 group-hover:text-sky-600 dark:group-hover:text-sky-400">Citas Médicas</h3>
                    ...
                    <a href="#" 
                       class="group bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 flex items-center space-x-4 hover:shadow-xl hover:scale-105 transition-transform duration-200">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 group-hover:text-rose-600 dark:group-hover:text-rose-400">Historial Médico</h3>
